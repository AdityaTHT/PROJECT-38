...
function setup() {
  ...
  ground2 = createSprite(width/30,height+80,width,305);  
  ground2.shapeColor = "#f4cbaa";
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width+20,height-10,40,10);
